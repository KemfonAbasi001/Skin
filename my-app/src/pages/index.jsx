...
function Hero() {
  return (
    <section
      className="w-full py-50 flex justify-center items-center bg-cover bg-center bg-no-repeat"
    ...
    >
      <div className="w-[90%] flex justify-end">
        <div className="w-full text-center font-[serif] text-[white]">
          <h1 className="text-[2.7rem] leading-[65px] tracking-[1px] font-medium">Glow with Aloe Naturally. Radiate Confidence.</h1>
          ...
          <button className="w-full py-3 bg-[white] text-[black] text-[1.2rem] rounded-full font-[500]" type="button">Shop Now</button>
        </div>
      </div>
    </section>
  )
