...
// import bgImage from '../assets/LandingPage_Image.webp'
// import img from '../assets/productImage.webp'
// import imgtwo from '../assets/Product_Background.webp'
// import imgthree from '../assets/Skinglow_Image.webp'
// import imgfour from '../assets/ProductBottled_Image.webp'
...
//   const [bestSellersHeadRef, bestSellersHeadVisible] = useReveal()
//   const [natureRef, natureVisible] = useReveal()
//   const [organicOneRef, organicOneVisible] = useReveal()
//   const [organicOneImgRef, organicOneImgVisible] = useReveal()
//   const [organicTwoImgRef, organicTwoImgVisible] = useReveal()
//   const [organicTwoRef, organicTwoVisible] = useReveal()
//   const [footerRef, footerVisible] = useReveal()

//   // ---- scroll to top whenever any anchor tag is clicked ----
//   useEffect(() => {
...
//       <section
//         ref={heroRef}
//         className="w-full py-45 sm:py-48 md:py-60 lg:py-70 flex justify-center items-center bg-cover bg-center bg-no-repeat transition-all duration-700 ease-out"
//         style={{
//           backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url(${bgImage})`,
...
//         <div className="w-[90%] flex flex-col gap-6 bg-white">
//           <h1
//             ref={bestSellersHeadRef}
//             className="text-[28px] sm:text-[25px] md:text-[29px] font-[serif] transition-all duration-700 ease-out"
//             style={{
//               opacity: bestSellersHeadVisible ? 1 : 0,
//               transform: bestSellersHeadVisible ? "translateY(0)" : "translateY(32px)",
//             }}
//           >
//             Best Sellers
//           </h1>
...
//         <section
//           ref={natureRef}
//           className="w-full py-20 sm:py-24 md:py-30 flex justify-center items-center bg-cover bg-center bg-no-repeat transition-all duration-700 ease-out"
//           style={{
//             backgroundImage: `url(${imgtwo})`,
//             opacity: natureVisible ? 1 : 0,
//             transform: natureVisible ? "translateY(0)" : "translateY(32px)",
//           }}
//         >
//           <div className="w-[90%] flex flex-col justify-center items-center gap-1 text-white text-center">
//             <h1 className="font-[serif] text-[26px] sm:text-[32px] md:text-[39px]">Nature's Heroes, Bottled</h1>
...
//         <div
//           ref={organicOneRef}
//           className="w-[90%] md:w-[48%] flex flex-col justify-center items-center gap-4 text-center transition-all duration-700 ease-out"
//           style={{
//             opacity: organicOneVisible ? 1 : 0,
//             transform: organicOneVisible ? "translateY(0)" : "translateY(32px)",
//           }}
//         >
//           <h1 className="font-[serif] text-[1.7rem] sm:text-[2rem] md:text-[2.3rem]">
//             Organic products, friendly for your skin
...
//         </div>
//         <span
//           ref={organicOneImgRef}
//           className="block w-full md:w-[48%] overflow-hidden transition-all duration-700 ease-out"
//           style={{
//             transitionDelay: "100ms",
//             opacity: organicOneImgVisible ? 1 : 0,
//             transform: organicOneImgVisible ? "translateY(0)" : "translateY(32px)",
//           }}
//         >
//           <img
//             src={imgthree}
...
//       <section className="py-10 sm:py-12 md:py-13 w-full flex flex-col md:flex-row md:justify-between items-center gap-8 md:gap-0">
//         <span
//           ref={organicTwoImgRef}
//           className="block w-full md:w-[48%] overflow-hidden transition-all duration-700 ease-out"
//           style={{
//             opacity: organicTwoImgVisible ? 1 : 0,
//             transform: organicTwoImgVisible ? "translateY(0)" : "translateY(32px)",
//           }}
//         >
//           <img
//             src={imgfour}
...
//           style={{
//             transitionDelay: "100ms",
//             opacity: organicTwoVisible ? 1 : 0,
//             transform: organicTwoVisible ? "translateY(0)" : "translateY(32px)",
//           }}
//         >
//           <h1 className="font-[serif] text-[1.7rem] sm:text-[2rem] md:text-[2.3rem]">
//             Organic products, friendly for your skin
...
//       <section
//         ref={footerRef}
//         className="flex justify-center py-16 bg-[#E4EBD2] transition-all duration-700 ease-out"
//         style={{
...
//       {/* Organic Section 1 */}
//       <section className="py-10 sm:py-12 md:py-13 w-full flex flex-col md:flex-row md:justify-between items-center gap-8 md:gap-0 overflow-hidden">
//         <div
//           ref={organicOneRef}
//           className="w-[90%] md:w-[48%] flex flex-col justify-center items-center gap-4 text-center transition-all duration-700 ease-out"
//           style={{
...
//             transitionDelay: "100ms",
//             opacity: organicOneImgVisible ? 1 : 0,
//             transform: organicOneImgVisible ? "translateX(0)" : "translateX(80px)",
//           }}
//         >
//           <img
//             src={imgthree}
...
//           style={{
//             opacity: organicTwoImgVisible ? 1 : 0,
//             transform: organicTwoImgVisible ? "translateX(0)" : "translateX(-80px)",
//           }}
//         >
//           <img
//             src={imgfour}
    ...
    <>
      ...
      >
        <div className="w-[90%]">
          <div
            ref={heroRef}
            className="w-full font-[serif] text-white text-center md:text-right md:flex md:flex-col md:items-end transition-all duration-700 ease-out"
            style={{
              opacity: heroVisible ? 1 : 0,
              transform: heroVisible ? "translateY(0)" : "translateY(32px)",
            }}
